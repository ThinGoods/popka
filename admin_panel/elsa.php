...
if(isset($_POST['title'], $_POST['full_text'], $_FILES['image'])) {
  ...
  $full_image_src = 'img/ELSA/'.$image_name;
  $full_src = '';
  ...
  function addOptionalImage($image) {
    ...
    if($image['name']) {
      ...
      $full_optional_image_src = 'img/ELSA/'.$image_optional_name;
      $full_src .= $full_optional_image_src.'$';
      move_uploaded_file($image_optional_temp, "../img/ELSA/".$image_optional_name);
    }
  }
  ...
  $sql = "INSERT INTO `elsa` (`title`, `description`, `images`,  `img`) VALUES ('$title', '$full_text', '$full_src', '$full_image_src')";
...
<form enctype="multipart/form-data" action="" method="post" class="form_added">
  <div>
    <div class="title">Додавання новини ELSA:</div>
  </div>
  <div class="inputs">
  <div>
    Введіть назву новини ELSA: <textarea name="title" data-type="title"></textarea>
  </div>
  <div>
    Введіть опис новини ELSA: <textarea name="full_text" data-type="text"></textarea>
  </div>
  <div>
...
<hr>
<div class="container">
<form action="deleted_elsa.php" method="post" class="form_deleted">
  <div>
    <div class="title">Видалення новини ELSA</div>
  </div>
