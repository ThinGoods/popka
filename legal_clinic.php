...
<!--  майн -->
  ...
  ?>
	...
	<div class="duo">
	  <img src="img/legal_clinic/students_1.jpg" class="a1">
	  <img src="img/legal_clinic/students_2.jpg" class="a1">
    </div>

	<div class="p">
	&nbsp;	&nbsp;	&nbsp;	&nbsp;Протягом навчання в юридичній клініці студенти відвідують школи юридичної клінічної освіти, семінари, тренінги, конференції, беруть участь в олімпіадах та конкурсах.
    </div>
	...
	<div class="p">
		&nbsp;	&nbsp;	&nbsp;	&nbsp;Правова допомога надається студентами юридичного факультету, що не є професійними юристами. Правова допомога надається у приміщенні юридичної клініки, що знаходиться за адресою: <a href="https://goo.gl/maps/D1CkczDr4kQaFtuw7" id="adress">м. Суми, вул.  Миру, буд. 24</a>
	</div>
